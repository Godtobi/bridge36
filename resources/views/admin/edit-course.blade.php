            ...
            <div class="col-md-9">
                ...
                <div class="tabbable paper-shadow relative" data-z="0.5">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="{{route('admin.course.edit')}}"><i class="fa fa-fw fa-lock"></i> <span class="hidden-sm hidden-xs">Course</span></a></li>
                        <li class=""><a href="{{route('admin.course.edit-description')}}"><i class="fa fa-fw fa-credit-card"></i> <span class="hidden-sm hidden-xs">Course Description</span></a></li>
