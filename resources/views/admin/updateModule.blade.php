        ...
        <div class="col-md-9">
          ...
          <div class="tabbable paper-shadow relative" data-z="0.5">
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a href=""><i class="fa fa-fw fa-credit-card"></i> <span class="hidden-sm hidden-xs">Update Module</span></a></li>
              ...
              <div id="course" class="tab-pane active">
                <form method="post" action="{{route('module.update')}}">
                  ...
                  <div class="form-group form-control-material">
                    <input type="text" name="name" value="{{$module->name}}" id="title" placeholder="Course Title" class="form-control used" value="Basics of HTML" />
                    <label for="title">Title</label>
                  </div>
                  <div class="form-group">
                    <label for="description">Description</label>
                    <textarea name="description" id="description" cols="30" rows="10" class="summernote">{{$module->description}}</textarea>
                  </div>
                  <input type="hidden" name="id" id="title"  class="form-control used" value="{{$id}}" />
