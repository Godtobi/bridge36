        ...
        <div class="col-md-9">
          ...
          <div class="tabbable paper-shadow relative" data-z="0.5">
            ...
            <ul class="nav nav-tabs">
              <li class="active"><a href="{{route('profile')}} "><i class="fa fa-fw fa-user"></i> <span class="hidden-sm hidden-xs">Profile</span></a></li>
              <li><a href="#"><i class="fa fa-fw fa-book"></i> <span class="hidden-sm hidden-xs">Course History</span></a></li>
