                            ...
                            <div class="panel-heading">
                                <div class="media v-middle">
                                    <div class="media-body">
                                        <h4 class="text-headline margin-none">Subscriptions</h4>
                    ...
                    <div class="item col-xs-12 col-lg-6">
                        <div class="panel panel-default paper-shadow" data-z="0.5">
                            <div class="panel-heading">
                                ...
                                <p class="text-subhead text-light">View recent courses</p>
                            ...
                            <ul class="list-group">
                                @foreach($courses as $course)
                                    ...
                                    <li class="list-group-item media v-middle">
                                        <div class="media-body">
                                            <a href="/admin/course/edit/{{$course->id}}" class="text-subhead list-group-link">{{$course->name}}</a>
                                        </div>
                                        <div class="media-right">
                            ...
                            <div class="panel-footer text-right">
                                <a href="/admin/courses" class="btn btn-white paper-shadow relative" data-z="0" data-hover-z="1" data-animated>View all</a>
                                <a href="/admin/course/edit" class="btn btn-primary paper-shadow relative" data-z="0" data-hover-z="1" data-animated>CREATE COURSE <i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table text-subhead v-middle">
                                    ...
                                    <tr>
                                        <td class="width-100 text-caption">
                                            <div class="label label-grey-200 label-xs">12 Jan 2019</div>
                                        </td>
                                        <td>Adrian Demian</td>
...
<!-- Mirrored from learning.frontendmatter.com/html/website-instructor-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Oct 2019 15:06:16 GMT -->
</html>
