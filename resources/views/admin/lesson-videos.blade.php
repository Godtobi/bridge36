              ...
              <div id="lessons" class="tab-pane active">
                <div class="media v-middle s-container">
                  ...
                  <div class="media-right">
                    <a class="btn btn-primary paper-shadow relative" href="/admin/course/{{$course}}/lesson/{{$lesson}}/create">Add Video</a>
                  </div>
                </div>
                          ...
                          <div class="media v-middle">
                            ...
                            <div class="media-body">
                              <h4 class="text-title media-heading margin-none">
                                <a  class="link-text-color">{{$video->name}}</a>
                              </h4>

                            </div>
                            <div class="media-right">
                              <a href="{{route('edit',$video->id)}}" class="btn btn-white btn-flat"><i class="fa fa-pencil fa-fw"></i> Edit</a>
                            </div>
                          </div>
                        </div>
                      </li>
