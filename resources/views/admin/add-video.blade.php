                ...
                <form method="post" action="{{route('video.store')}}" enctype="multipart/form-data" class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9 col-md-4">
                      <input name="name" id="text" type="text" class="form-control">
                    </div>
                    <div>
                      @error('name')
                  ...
                  <input name="course_id" value="{{$course}}" type="hidden" >
                  <input name="lesson_id" value="{{$lesson}}" type="hidden" >
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-3 control-label">Video Description</label>
                    <div class="col-md-6">
                      <div class="media v-middle">
                        ...
                        <div class="media-body">
                          <input name="video" data-z="0.5" data-hover-z="1" placeholder="Upload Video" class="form-control btn btn-white btn-sm paper-shadow relative" type="file">
                        </div>
                        <div>
                          @error('video')
                          <span class="alert text-danger">
                  ...
                  <div class="form-group">
                    <label for="start" class="col-sm-3 control-label">Duration</label>
                    <div class="col-sm-9 col-md-4">
                      <input name="duration" id="text" type="number" step="0.01" class="form-control">
                    </div>
                    <div>
                      @error('duration')
                      <span class="alert text-danger">
