        ...
        <div class="col-md-9">
          ...
          <div class="tabbable paper-shadow relative" data-z="0.5">
            ...
            <ul class="nav nav-tabs">
              ...
              <li><a href="{{route('admin.course.edit-description')}}"><i class="fa fa-fw fa-credit-card"></i> <span class="hidden-sm hidden-xs">Course Description</span></a></li>
              <li class="active"><a href="{{route('tutor.create',$id)}}"><i class="fa fa-fw fa-credit-card"></i> <span class="hidden-sm hidden-xs">Course Instructor</span></a></li>
            </ul>
            <!-- // END Tabs -->
            ...
            <div class="tab-content">
              ...
              <div id="account" class="tab-pane active">
                ...
                @endif
                <form method="post" action="{{route('tutor.store')}}" enctype="multipart/form-data"  class="form-horizontal">
                  @csrf
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-control-material">
                            <input type="text" name="firstname" class="form-control" id="exampleInputFirstName" placeholder="Your first name">
                      ...
                      <div>
                        ...
                        <div class="col-md-6">
                          <div class="form-control-material">
                            <input type="text" name="lastname" class="form-control" id="exampleInputLastName" placeholder="Your last name">
                        <div>
                          @error('lastname')
                          <span class="alert text-danger">
                                        <strong>{{ $message }}</strong>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="form-control-material">
                        <div class="input-group">
                          <!-- <span class="input-group-addon"><i class="fa fa-link"></i></span> -->
                          <textarea name="description" class="form-control used"> </textarea>
                          <div>
                            @error('description')
                            <span class="alert text-danger">
                                        <strong>{{ $message }}</strong>
