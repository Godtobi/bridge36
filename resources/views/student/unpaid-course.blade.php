        ...
        <div class="col-md-9">
          ...
          <div class="page-section padding-top-none">
            <div class="media media-grid v-middle">
              ...
              <div class="pull-right">    <a  class="btn btn-primary btn-flat paper-shadow relative" data-z="0" data-hover-z="1" data-animated href="{{'/course/'.$course->id.'/price/24'}}">Subscribe </a></div>
