        ...
        <div class="col-md-9">
          ...
          <div class="tabbable paper-shadow relative" data-z="0.5">
            ...
            <ul class="nav nav-tabs">
              <li class="active"><a href="{{route('profile')}} "><i class="fa fa-fw fa-lock"></i> <span class="hidden-sm hidden-xs">Manage Account</span></a></li>
              <li><a href="{{route('updatepassword')}}"><i class="fa fa-fw fa-lock "></i> <span class="hidden-sm hidden-xs">Change password</span></a></li>
              <li class=""><a href="{{route('billing')}}"><i class="fa fa-fw fa-credit-card "></i> <span class="hidden-sm hidden-xs">Subscription history</span></a></li>
            </ul>
            <!-- // END Tabs -->
          ...
          <div class="text-center">
                      <a href="{{route('update.profile')}}"><button type="button" class="btn btn-primary paper-shadow relative" data-z="0.5" data-hover-z="1" data-animated>Update Profile</button></a>
