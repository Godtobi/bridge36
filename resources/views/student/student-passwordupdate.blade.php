        ...
        <div class="col-md-9">
          ...
          <div class="tabbable paper-shadow relative" data-z="0.5">
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a  href="{{route('updatepassword')}}"><i class="fa fa-fw fa-lock "></i> <span class="hidden-sm hidden-xs">Change password</span></a></li>
              <li ><a href="{{route('billing')}}"><i class="fa fa-fw fa-credit-card "></i> <span class="hidden-sm hidden-xs">Subscription history</span></a></li>
            </ul>
            <!-- // END Tabs -->
              ...
              <div id="billing" class="tab-pane active">
                <form action="{{route('password.update')}}" method="post" class="form-horizontal">
                    ...
                    @endif
                      ...
                      <div class="col-md-6">
                        <div class="form-control-material">
                          <input type="password" name="password" class="form-control" id="inputPassword3" placeholder="Old Password">
                          @error('password')
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="form-control-material">
                        <input type="password" name="new-password" class="form-control" id="inputPassword3" placeholder="New Password">
                      </div>
                    </div>
                  </div>
