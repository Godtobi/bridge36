            ...
            <div class="panel panel-default text-center paper-shadow" data-z="0.5">
                ...
                {{--@endif--}}
                    ...
                    <form  method="post" action="{{route('register')}}">
                        ...
                        <div class="form-group">
                            <div class="form-control-material">
                                <textarea id="description" name="description" type="text" maxlength="40" class="form-control" placeholder="Description"> </textarea>
                        ...
                        <div class="form-group">
                            <div class="form-control-material">
                                <input name="password_confirmation" id="passwordConfirmation" type="password" class="form-control" placeholder="Password Confirmation">
